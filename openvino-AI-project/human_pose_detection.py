...
human_model = torch.hub.load('ultralytics/yolov5', 'custom', path='./human_detection.pt', _verbose=False, force_reload=True)
color_model = torch.hub.load('ultralytics/yolov5', 'custom', path='./color_detection.pt', _verbose=False, force_reload=True)
